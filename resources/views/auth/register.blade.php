<x-guest-layout>
    ...
    <div class="flex items-center w-full mt-5 md:mt-20 p-4 lg:justify-center">
        ...
        <div
            ...
            <div
                class="text-white bg-red-300 bg-login-img-a bg-left bg-cover md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly">
            ...
            <div class="p-5 bg-white md:flex-1">
                ...
                @if ($errors->any())
                    <div class="bg-third text-white p-2">
                ...
                <form action="{{ route('register') }}" method="POST" class="flex flex-col space-y-5">
                    @csrf
                    ...
                    <div class="flex flex-col space-y-1">
                        <label for="password_confirmation" class="text-sm font-semibold text-gray-500">Confirm
                            Password</label>
